    ...
    <form id="form1" runat="server">
        <asp:Panel ID="Panel1" runat="server" BackColor="Silver" Height="469px" style="top: 12px; left: -232px; position: absolute; width: 1249px; height: 469px; background-color: Silver">
            <asp:Panel ID="Panel2" runat="server" BackColor="White" style="top: 178px; left: 798px; position: absolute; height: 284px; width: 449px">
                <asp:Button ID="Ingresar" runat="server" BackColor="#33CC33" BorderColor="#009933" Font-Bold="False" Font-Underline="False" ForeColor="White" style="top: 206px; left: 176px; position: absolute; height: 26px; width: 130px; background-color: #009933; font-size: medium; font-family: Montserrat-Thin;" Text="Ingresar" />
